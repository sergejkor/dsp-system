...
export const KPI_TRANSLATION_KEYS = {
  ...
  drivers_worked_today: 'driversWorkedToday',
  routes_completed_today: 'routesCompletedToday',
  route_completion_rate: 'routeCompletionRate',
  attendance_rate: 'attendanceRate',
  total_payroll_this_month: 'totalPayrollThisMonth',
  total_advances_this_month: 'totalAdvancesThisMonth',
  total_deductions_this_month: 'totalDeductionsThisMonth',
  safety_incidents_this_week: 'safetyIncidentsThisWeek',
