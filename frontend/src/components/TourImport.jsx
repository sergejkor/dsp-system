...
function ViewportOverlay({ children }) {
...
export default function TourImport({ defaultDate, onApplied, beforeImport }) {
  ...
  return <div className="tour-import" data-portal-localized>
    ...
    {open && <div className="tour-import-panel">
      ...
      {confirmOpen && draft && <ViewportOverlay><div className="tour-import-dialog-backdrop" onClick={() => setConfirmOpen(false)}>
      ...
      {updatedPlanOpen && updatedPlan && <ViewportOverlay><div className="tour-import-dialog-backdrop" onClick={() => setUpdatedPlanOpen(false)}>
      ...
      {rescueOpen && draft && <ViewportOverlay><div className="tour-import-dialog-backdrop tour-import-rescue-backdrop" onClick={() => setRescueOpen(false)}>
