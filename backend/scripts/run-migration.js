...
async function run() {
  try {
    ...
    await query(readFileSync(new URL('../migrations/008_kenjo_time_off_type_name.sql', import.meta.url), 'utf8'));
    console.log('Migration OK: Kenjo time-off type name column.');
  } catch (e) {
