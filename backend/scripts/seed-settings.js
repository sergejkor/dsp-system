...
const SETTINGS_GROUPS = [
  ...
  { key: 'internal_inspections', label: 'Internal inspections', description: 'Internal inspection reminders and WhatsApp cadence', sort_order: 45 },
...
const SETTINGS_ITEMS = [
  ...
  { group_key: 'internal_inspections', key: 'enabled', label: 'Enable internal inspection reminders', value_type: 'boolean', value_boolean: true, default_value_json: 'true' },
  { group_key: 'internal_inspections', key: 'reminder_message', label: 'Reminder message', value_type: 'string', value_text: 'Hi {{driverName}}, please complete today\'s internal inspection for {{licensePlate}}: {{inspectionUrl}}', default_value_json: `"Hi {{driverName}}, please complete today's internal inspection for {{licensePlate}}: {{inspectionUrl}}"` },
  { group_key: 'internal_inspections', key: 'reminder_start_time', label: 'Reminder start time', value_type: 'string', value_text: '10:00', default_value_json: '"10:00"' },
  { group_key: 'internal_inspections', key: 'reminder_interval_minutes', label: 'Reminder interval (minutes)', value_type: 'number', value_number: 60, default_value_json: '60', unit: 'min' },
  { group_key: 'internal_inspections', key: 'public_base_url', label: 'FleetCheck public URL', value_type: 'string', value_text: 'https://fleetcheck.alfamile.com', default_value_json: '"https://fleetcheck.alfamile.com"' },
  { group_key: 'internal_inspections', key: 'default_country_code', label: 'Default country code for WhatsApp numbers', value_type: 'string', value_text: '+49', default_value_json: '"+49"' },
