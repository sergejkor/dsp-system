...
const PERSONALFRAGEBOGEN_DEFAULT_PDF_LAYOUT = {
  summaryCards: [
...
const PERSONALFRAGEBOGEN_DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    value_type: 'string',
    value_text: 'AlfaMile GmbH',
    default_value_json: '"AlfaMile GmbH"',
  ...
  },
  {
    ...
    label: 'PDF title',
    value_type: 'string',
    value_text: 'Personalfragebogen',
    default_value_json: '"Personalfragebogen"',
  ...
  },
  {
    ...
    value_type: 'string',
    value_text: 'Segoe UI',
    default_value_json: '"Segoe UI"',
    description: 'Canvas font family used when rebuilding the Personalfragebogen PDF.',
    sort_order: 42,
  },
  {
  ...
  },
  {
    ...
    value_type: 'json',
    value_json: PERSONALFRAGEBOGEN_DEFAULT_PDF_LAYOUT,
    default_value_json: PERSONALFRAGEBOGEN_DEFAULT_PDF_LAYOUT,
    description: 'Stores section order, visibility, and custom manual blocks for the Personalfragebogen PDF.',
    sort_order: 48,
  },
];
